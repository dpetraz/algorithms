...
function splitOnVal(list, num){
    // find which node has num as the value in the list
    var current = list.head;
    var secondList = new slList();
    var prev = null;                        // in case we split on the first node, the adjusted list won't be blank
    while (current){
        if (current.nodeValue === num){
...
console.log(splitOnVal(mylist,10));
